...
def get_paragraph_count(html_snippet):
...
def clean_html(input):
   return input.split("START OF THE PROJECT GUTENBERG EBOOK")[1]


def get_paragraphs(current, html):
  max = math.floor(get_paragraph_count(html)/5)
  print(max)
  ...
  for i in range(5):
    if current <= max :
        output+="<p>" + paragraphs[(current-1)*5+i].getText() + "</p>"
       
  return output

# Example usage
html = """
<p>The Project Gutenberg eBook of Metamorphosis</p>
...
<p><strong><em> This is a COPYRIGHTED Project Gutenberg eBook. Details Below. </em></strong>
<strong><em>     Please follow the copyright guidelines in this file.      </em></strong></p>
<p>Title: Metamorphosis</p>
<p>Author: Franz Kafka</p>
<p>Translator: David Wyllie</p>
<p>Release date: August 17, 2005 [eBook #5200]
                Most recently updated: April 28, 2021</p>
<p>Language: English</p>
<p><strong><em> START OF THE PROJECT GUTENBERG EBOOK METAMORPHOSIS </em></strong></p>
<p>Metamorphosis</p>
<p>by Franz Kafka</p>
<p>Translated by David Wyllie</p>
<p>I</p>
...
rest of him, waved about helplessly as he looked.</p>
<p>“What’s happened to me?” he thought. It wasn’t a dream. His room, a
...
the whole of her lower arm towards the viewer.</p>
<p>Gregor then turned to look out the window at the dull weather. Drops of
...
pain there that he had never felt before.</p>
<p>“Oh, God”, he thought, “what a strenuous career it is that I’ve chosen!
...
shudder.</p>
<p>He slid back into his former position. “Getting up early all the time”,
...
completely well and even felt much hungrier than usual.</p>
<p>He was still hurriedly thinking all this through, unable to decide to
...
at night even when he was at home.</p>
<p>The first thing he wanted to do was to get up in peace without being
...
<p>It was a simple matter to throw off the covers; he only had to blow
...
to himself, “so don’t keep trying to do it”.</p>
<p>The first thing he wanted to do was get the lower part of his body out
...
well, at present, be the most sensitive.</p>
...
to stay in bed than lose consciousness.</p>
<p>It took just as much effort to get back to where he had been earlier,
...
natural state.</p>
<p>But then he said to himself: “Before it strikes quarter past seven I’ll
...
raise concern if not alarm. But it was something that had to be risked.</p>
...
could not suppress a smile at this thought.</p>
<p>After a while he had already moved so far across that it would have
...
the carpet.</p>
<p>“Something’s fallen down in there”, said the chief clerk in the room on
...
<p>“Gregor”, said his father now from the room to his left, “the chief
...
his sister began to cry.</p>
<p>So why did his sister not go and join the others? She had probably only
...
excuse their behaviour.</p>
<p>The chief clerk now raised his voice, “Mr. Samsa”, he called to him,
...
Samsa, we cannot allow there to be.”</p>
<p>“But Sir”, called Gregor, beside himself and forgetting all else in the
...
as to tell that to the boss and recommend me to him!”</p>
<p>And while Gregor gushed out these words, hardly knowing what he was
...
kept quiet so that he could listen to what the chief clerk was saying.</p>
...
<p>Gregor, in contrast, had become much calmer. So they couldn’t
...
<p>Gregor slowly pushed his way over to the door with the chair. Once
...
door to open it completely.</p>
<p>Because he had to open the door in this way, it was already wide open
...
his hands and wept so that his powerful chest shook.</p>
<p>So Gregor did not go into the room, but leant against the inside of the
...
the stairs where they began their way down below.</p>
sharply and left, slamming the door terribly as she went.</p>
<p>“Tonight she gets sacked”, said Mr. Samsa, but he received no reply
...
their letters.</p>
<p>After that, the three of them left the flat together, which was
...
first to get up and stretch out her young body.</p>
<p><strong><em> END OF THE PROJECT GUTENBERG EBOOK METAMORPHOSIS </em></strong></p>
...
<pre><code>This eBook is for the <span class="hljs-keyword">use</span> <span class="hljs-keyword">of</span> anyone anywhere <span class="hljs-keyword">in</span> the United States <span class="hljs-keyword">and</span> most
other parts <span class="hljs-keyword">of</span> the world <span class="hljs-keyword">at</span> <span class="hljs-keyword">no</span> <span class="hljs-keyword">cost</span> <span class="hljs-keyword">and</span> <span class="hljs-keyword">with</span> almost <span class="hljs-keyword">no</span> restrictions
whatsoever. You may copy it, give it away <span class="hljs-keyword">or</span> re-<span class="hljs-keyword">use</span> it <span class="hljs-keyword">under</span> the terms
<span class="hljs-keyword">of</span> the <span class="hljs-keyword">Project</span> Gutenberg License included <span class="hljs-keyword">with</span> this eBook <span class="hljs-keyword">or</span> <span class="hljs-keyword">online</span>
<span class="hljs-keyword">at</span> www.gutenberg.org. <span class="hljs-keyword">If</span> you
<span class="hljs-keyword">are</span> <span class="hljs-keyword">not</span> located <span class="hljs-keyword">in</span> the United States, you will have <span class="hljs-keyword">to</span> <span class="hljs-keyword">check</span> the laws
<span class="hljs-keyword">of</span> the country <span class="hljs-keyword">where</span> you <span class="hljs-keyword">are</span> located <span class="hljs-keyword">before</span> <span class="hljs-keyword">using</span> this eBook.
</code></pre><p>1.E.2. If an individual Project Gutenberg™ electronic work is
...
provided that:</p>
<pre><code>• You pay a royalty fee of 20% of the gross profits you derive from
    the <span class="hljs-keyword">use</span> <span class="hljs-keyword">of</span> <span class="hljs-keyword">Project</span> Gutenberg™ works calculated <span class="hljs-keyword">using</span> the method
    you already <span class="hljs-keyword">use</span> <span class="hljs-keyword">to</span> calculate your applicable taxes. The fee <span class="hljs-keyword">is</span> owed
    <span class="hljs-keyword">to</span> the owner <span class="hljs-keyword">of</span> the <span class="hljs-keyword">Project</span> Gutenberg™ trademark, but he has
    agreed <span class="hljs-keyword">to</span> donate royalties <span class="hljs-keyword">under</span> this paragraph <span class="hljs-keyword">to</span> the <span class="hljs-keyword">Project</span>
    Gutenberg Literary <span class="hljs-keyword">Archive</span> Foundation. Royalty payments must be paid
    <span class="hljs-keyword">within</span> <span class="hljs-number">60</span> <span class="hljs-keyword">days</span> <span class="hljs-keyword">following</span> <span class="hljs-keyword">each</span> <span class="hljs-built_in">date</span> <span class="hljs-keyword">on</span> which you <span class="hljs-keyword">prepare</span> (<span class="hljs-keyword">or</span> <span class="hljs-keyword">are</span>
    legally <span class="hljs-keyword">required</span> <span class="hljs-keyword">to</span> <span class="hljs-keyword">prepare</span>) your periodic tax returns. Royalty
    payments should be clearly marked <span class="hljs-keyword">as</span> such <span class="hljs-keyword">and</span> sent <span class="hljs-keyword">to</span> the <span class="hljs-keyword">Project</span>
    Gutenberg Literary <span class="hljs-keyword">Archive</span> Foundation <span class="hljs-keyword">at</span> the address specified <span class="hljs-keyword">in</span>
    <span class="hljs-keyword">Section</span> <span class="hljs-number">4</span>, “Information about donations <span class="hljs-keyword">to</span> the <span class="hljs-keyword">Project</span> Gutenberg
    Literary <span class="hljs-keyword">Archive</span> Foundation.”

• You provide a <span class="hljs-keyword">full</span> refund <span class="hljs-keyword">of</span> <span class="hljs-keyword">any</span> money paid <span class="hljs-keyword">by</span> a <span class="hljs-keyword">user</span> who notifies
    you <span class="hljs-keyword">in</span> writing (<span class="hljs-keyword">or</span> <span class="hljs-keyword">by</span> e-mail) <span class="hljs-keyword">within</span> <span class="hljs-number">30</span> <span class="hljs-keyword">days</span> <span class="hljs-keyword">of</span> receipt that s/he
    does <span class="hljs-keyword">not</span> agree <span class="hljs-keyword">to</span> the terms <span class="hljs-keyword">of</span> the <span class="hljs-keyword">full</span> <span class="hljs-keyword">Project</span> Gutenberg™
    License. You must require such a <span class="hljs-keyword">user</span> <span class="hljs-keyword">to</span> <span class="hljs-keyword">return</span> <span class="hljs-keyword">or</span> destroy all
    copies <span class="hljs-keyword">of</span> the works possessed <span class="hljs-keyword">in</span> a <span class="hljs-keyword">physical</span> <span class="hljs-keyword">medium</span> <span class="hljs-keyword">and</span> discontinue
    all <span class="hljs-keyword">use</span> <span class="hljs-keyword">of</span> <span class="hljs-keyword">and</span> all <span class="hljs-keyword">access</span> <span class="hljs-keyword">to</span> other copies <span class="hljs-keyword">of</span> <span class="hljs-keyword">Project</span> Gutenberg™
    works.

• You provide, <span class="hljs-keyword">in</span> accordance <span class="hljs-keyword">with</span> paragraph <span class="hljs-number">1.</span>F<span class="hljs-number">.3</span>, a <span class="hljs-keyword">full</span> refund <span class="hljs-keyword">of</span>
    <span class="hljs-keyword">any</span> money paid <span class="hljs-keyword">for</span> a <span class="hljs-keyword">work</span> <span class="hljs-keyword">or</span> a replacement copy, <span class="hljs-keyword">if</span> a defect <span class="hljs-keyword">in</span> the
    electronic <span class="hljs-keyword">work</span> <span class="hljs-keyword">is</span> discovered <span class="hljs-keyword">and</span> reported <span class="hljs-keyword">to</span> you <span class="hljs-keyword">within</span> <span class="hljs-number">90</span> <span class="hljs-keyword">days</span> <span class="hljs-keyword">of</span>
    receipt <span class="hljs-keyword">of</span> the work.

• You comply <span class="hljs-keyword">with</span> all other terms <span class="hljs-keyword">of</span> this agreement <span class="hljs-keyword">for</span> free
    distribution <span class="hljs-keyword">of</span> <span class="hljs-keyword">Project</span> Gutenberg™ works.
</code></pre><p>1.E.9. If you wish to charge a fee or distribute a Project
...
<p>The Foundation’s business office is located at 809 North 1500 West,
...
visit www.gutenberg.org/donate.</p>
...
paragraph = get_paragraphs(1,clean_html(html) )
print(f"{paragraph}")
