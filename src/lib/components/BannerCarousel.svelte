...
<div class="grid grid-cols-[auto_1fr_auto] gap-4 items-center">
	...
	>
		...
		{#each thumbs.books as book}
			<a href={book.url} target="_blank" class="shrink-0 w-96 h-48 snap-start rounded-sm">
				<img
					class="rounded-container-token object-cover w-full h-full hover:brightness-125"
